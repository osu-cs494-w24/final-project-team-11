...
export function PlaceBet({ friend, onClose }) {
  ...
  console.log("Place Bet == events: ", events)
        ...
        <BettersContainer>
          <BetterCard>
            ...
            <Info>
              ...
              <Value>{selectedEvent?.bookmakers[0].markets[0].outcomes[0].price || 'Select an event'}</Value>
            </Info>
            <Info>
              <Label>Amount:</Label>
          ...
          <BetterCard>
            ...
            <Info>
              ...
              <Value>{selectedEvent?.bookmakers[0].markets[0].outcomes[1].price || 'TBD'}</Value> {/* Adjust based on your logic */}
            </Info>
            <Info>
              <Label>Amount:</Label>
  ...
  <option key={event.id} value={event.id}>
    {event.home_team} ({event.bookmakers[0].markets[0].outcomes[0].price}) vs. {event.away_team} ({event.bookmakers[0].markets[0].outcomes[1].price})
  </option>
))}
        </Select>
        <Input
